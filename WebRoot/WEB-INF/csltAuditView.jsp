...
<html>
  <head>
    ...
    <style type="text/css">
    	...
    	.list .li_l{padding:5px 1%; width:50%; float:left;}
    	.list .li_r{padding:5px 1%; background:#eeeeee; width:50%; float:left;}
    	.list .line{margin:0px auto; clear:both;}
    	.list .text{width:95%; min-height:60px;}
    	.list .textarea{width:95%; min-height:370px;}
    	.a_link{margin:0px 5px; color:#000; line-height:1.7em;}
    	.refresh{margin-right:15px; float:right;}
    </style>
...
<!-- 		<div id="da_evf_head" style="margin:0px auto; min-width:1000px; width:90%; height:60px; overflow:hidden;">
    ...
    <div id='jqxWidget' style="font-size: 13px; font-family: Verdana;">
		<div id="jqxgrid" style="margin:0px auto; min-width:1000px;"></div>
